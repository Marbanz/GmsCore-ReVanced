...
class MapContext(private val context: Context) : ContextWrapper(context.createPackageContext(Constants.USER_MICROG_PACKAGE_NAME, Context.CONTEXT_INCLUDE_CODE or Context.CONTEXT_IGNORE_SECURITY)) {
